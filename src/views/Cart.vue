            ...
            <div class="flow-root">
              <ul class="-my-8">
                <li v-for="cart in getCart" :key="cart.cart_id"
                  ...
                  <div class="shrink-0">
                    <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz536Dca3SbnxbnfktcYSM_EcyN3-fTkdwAv1vRG22WLDaVhXW3_fPReg5AW5vBClz0Ls&usqp=CAU" alt="" />
                  </div>
